...
const ContactSection = () => {
  ...
  />
          ...
          <div className="w-full lg:w-2/3 flex flex-col">
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-1.5 sm:gap-2 md:gap-3 lg:gap-1.5 xl:gap-2 transition-opacity duration-1200 delay-700 ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
