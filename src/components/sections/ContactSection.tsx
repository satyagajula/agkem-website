      ...
      <div className="container-custom h-full">
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4 h-full">
          ...
          <div className="w-full lg:w-2/3 flex flex-col">
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-1.5 sm:gap-2 md:gap-3 lg:gap-1.5 xl:gap-2 2xl:gap-3 3xl:gap-4 4xl:gap-5 transition-opacity duration-1200 delay-700 ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
              
              {/* Left Column */}
              <div className="flex flex-col gap-1 sm:gap-1 md:gap-1 lg:gap-1 xl:gap-2 2xl:gap-2 3xl:gap-3 4xl:gap-6 h-full">
