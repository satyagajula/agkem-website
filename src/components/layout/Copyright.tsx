...
const Copyright = () => {
  return (
    <div 
      className="fixed bottom-0 left-0 right-0 z-40 text-white py-1.5 sm:py-2 2xl:py-4" 
      style={{ backgroundColor: '#2C3E2C', opacity: 0.95 }}
    >
      <div className="container-custom">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 2xl:gap-6">
          
          {/* Copyright text - centered */}
          <div className="text-center flex-1 w-full sm:w-auto">
            <p className="text-[9px] sm:text-[10px] 2xl:text-base text-gray-300 mb-0.5 2xl:mb-1">
              © 2025 AG KEM. Todos los derechos reservados.
            </p>
            <p className="text-[8px] sm:text-[9px] 2xl:text-sm text-gray-400 leading-relaxed">
              El uso de agroquímicos debe realizarse conforme a etiqueta y por personal capacitado
            </p>
          </div>
          
          {/* Social Icons */}
          <div className="flex space-x-2 sm:space-x-3 2xl:space-x-4 flex-shrink-0">
            <a
